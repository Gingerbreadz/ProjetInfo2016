...
class Diagnostique:
    ...
    def get_attack(self, attack):
        ...
        for url, e in L2[:5]:
            L.append("\033[37mURL\033[0m\033[35m " + str(url) + "\033[0m\n\t\033[37mImpact\033[0m\t\t\033[97m" + str(e[2]) + "\033[0m\n\t\033[37mDescription\033[0m\t\033[97m" + str(e[1]) + "\033[0m\n\t\033[37mHits\033[0m\t\t\033[97m" + str(len(e[0])) + "\033[0m\n\t\033[37mLogLineNumbers\033[0m\t\033[97m" + ", ".join(e[0]) + "\033[0m\n\n")
